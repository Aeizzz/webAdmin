    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#dataList").datagrid({
                ...
                columns:[[
                    ...
                    {field:'name',title:'分类名称',width:40},
        ...
        function deleteDate(id) {
            $.messager.confirm('确认','您确认想要删除该信息吗？',
                function(r) {
                    if (r) {
                        var url = '${ctx}/lhl/category/delete?id='+id;
        ...
        function edit(id) {
            ...
            $.modalDialog({
                ...
                width : 500,
                height : 500,
                href : "${ctx}/lhl/category/form?id="+id
            });
        }
