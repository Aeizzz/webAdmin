...
<body>
	<div id="assignRole" style="margin: 0 auto;width: 800px">
		<div style="margin: 0;padding:0;border-right: 1px solid #A8A8A8;float: left;width: 200px">
			<p>所在部门：</p>
		...
		<div style="margin: 0;padding:0;border-left: 1px solid #A8A8A8;float: right;width: 200px">
			<p>已选人员：</p>
	...
	<script type="text/javascript">
        ...
        function treeOnClick(event, treeId, treeNode, clickFlag){
            ...
            if("officeTree"==treeId){
                var url = '${ctx}/sys/role/users';
                if(treeNode.type != '3'){
                    url += "?officeId=" + treeNode.id;
                }else{
                    url += "?departmentId=" + treeNode.id;
                }
