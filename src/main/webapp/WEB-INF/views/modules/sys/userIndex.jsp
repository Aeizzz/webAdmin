...
<head>
	...
	<style type="text/css">
		...
		.ztree li span.button.ico_open, .ztree li span.button.ico_close ,.ztree li span.button.ico_docu {
			...
			background: url(${pageContext.request.contextPath}/static/images/icon/icon_dept.png) 0px 1px;
		}
	</style>
</head>
<body>
	...
	<script type="text/javascript">
		var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
			callback:{onClick:function(event, treeId, treeNode){
                	...
                	$('#officeContent').attr("src","${ctx}/sys/user/list?office.id="+id+"&office.name="+treeNode.name+"&"+param);
            }
        }
		};
