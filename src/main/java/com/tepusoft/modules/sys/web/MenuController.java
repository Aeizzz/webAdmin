...
public class MenuController extends BaseController {
	...
	@ResponseBody
	public List<Menu> dataList(Menu menu, Model model) {
		List<Menu> list = Lists.newArrayList();
		List<Menu> sourcelist = systemService.findAllMenu();
		Menu.sortList(list, sourcelist, Menu.getRootId(), true);
		return list;
	...
	@ResponseBody
	public JqueryResult save(Menu menu, Model model, RedirectAttributes redirectAttributes) {
		if(!UserUtils.getUser().isAdmin()){
			return new JqueryResult.Builder(FAIL_CODE).message("越权操作，只有超级管理员才能添加或修改数据！").build();
		}

		String message=beanValidatorStr(model, menu);
	...
	@ResponseBody
	public JqueryResult delete(Menu menu, RedirectAttributes redirectAttributes) {
...
//		}
		return new JqueryResult.Builder(SUCCESS_CODE).message("删除菜单成功").build();
		//return "redirect:" + adminPath + "/sys/menu/";
	}
