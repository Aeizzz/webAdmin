 ...
 */
package com.tepusoft.modules.act.utils;
...
import com.tepusoft.common.annotation.FieldName;
import com.tepusoft.common.config.Global;
import com.tepusoft.common.utils.Encodes;
import com.tepusoft.common.utils.ObjectUtils;
...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	 ...
	 */
	public static final String[] PD_RZZG1_PROCESS = new String[]{"department_pro", "BASE_INFO"};
	public static final String[] PD_RZZG2_PROCESS = new String[]{"company_pro", "BASE_INFO"};
	public static final String[] PD_MAN_PROCESS = new String[]{"man_process", "business_lob"};
	...
	public static final String[] PD_TEST_CUSTOMFORM = new String[]{"customForm"};
//	/**
//	 * 流程定义Map（自动初始化）
//	 */
...
//	}
	...
	public static String getFormUrl(String formKey, Act act){
		...
		formUrl.append("&act.procInstId=").append(act.getProcInstId() != null ? act.getProcInstId() : "");
		...
		formUrl.append("&businessNumber=").append(act.getBusinessId() != null ? act.getBusinessId() : "");
