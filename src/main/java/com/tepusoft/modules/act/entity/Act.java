 ...
 */
package com.tepusoft.modules.act.entity;
...
import com.tepusoft.common.persistence.BaseEntity;
import com.tepusoft.common.utils.StringUtils;
import com.tepusoft.common.utils.TimeUtils;
import com.tepusoft.modules.act.utils.Variable;
...
//	private Variable taskVars; 	// 流程任务变量
	...
	/**
	 * 辅助字段，用来标识，跳转到审核页面，还是跳转到详情页面。<br/>
	 * 0:跳转审核页面，1：跳转详情页面
	 */
