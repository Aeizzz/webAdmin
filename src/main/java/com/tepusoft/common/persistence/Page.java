...
public class Page<T> {
    ...
    public Page(HttpServletRequest request, HttpServletResponse response, int defaultPageSize) {
        ...
        }else if(StringUtils.isNumeric(easyPage)){
        	//支持easyUI的分页的方法
        	 this.setPageNo(Integer.parseInt(easyPage));
        }
  
        
        // 设置页面大小参数（传递repage参数，来记住页码大小）
        String size = request.getParameter("pageSize");
        String easySize=request.getParameter("rows");
        ...
        }else if(StringUtils.isNumeric(easySize)){
        	  this.setPageSize(Integer.parseInt(easySize));
